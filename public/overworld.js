...
//     bounds: L.latLngBounds(L.latLng(-128, 0), L.latLng(0, 256)),
//     tileSize: 256
// })
var oldtarget;
// var OverworldInfo = L.geoJson(overworldVector, {
//     style: style,
...
// Lake Verity
markerSet(-439.12, 107.45, "TM38 (Fire Blast)", tmIcon, currentMap)
// Route 219
markerSet(-481, 223.5, "Zinc", hiddenIcon, currentMap)
markerSet(-472, 217.5, "Antidote", itemIcon, currentMap)
// Route 202
markerSet(-419, 210.5, "Potion", itemIcon, currentMap)
// Jubilife City
markerSet(-410.25, 216.5, "Stardust", hiddenIcon, currentMap)
...
// Canalave City
markerSet(-384.95, 82.45, "TM89 (U-Turn)", tmIcon, currentMap)
markerSet(-378.06, 84.45, "Big Pearl", hiddenIcon, currentMap)
// Route 203
...
markerSet(-392, 339.25, "Pearl", hiddenIcon, currentMap)
markerSet(-394.5, 343.5, "Dire Hit", itemIcon, currentMap)
markerSet(-393.25, 342.25, "Heart Scale", hiddenIcon, currentMap)
// Route 207
markerSet(-343.68, 339.18, "Poké Ball", itemIcon, currentMap)
markerSet(-343.75, 347.18, "Poké Ball", hiddenIcon, currentMap)
...
markerSet(-348, 361.25, "Rare Candy", hiddenIcon, currentMap)
markerSet(-348.62, 386, "Revive", hiddenIcon, currentMap)
markerSet(-343.75, 385.25, "Great Ball", hiddenIcon, currentMap)
...
markerSet(-507, 229.40, "Big Pearl", hiddenIcon, currentMap)
markerSet(-503.35, 247.45, "Carbos", itemIcon, currentMap)
// Route 221
markerSet(-504.62, 356.45, "Carbos", hiddenIcon, currentMap)
markerSet(-506.82, 343.4, "TM81 (X-Scissor)", tmIcon, currentMap)
markerSet(-506.12, 328.45, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-503.06, 320.45, "Max Revive", hiddenIcon, currentMap)
markerSet(-507.68, 315.45, "Hyper Potion", hiddenIcon, currentMap)
...
markerSet(-487.62, 312.45, "Big Mushroom", hiddenIcon, currentMap)
...
markerSet(-277.5, 260.5, "Stardust", hiddenIcon, currentMap)
markerSet(-194.36, 333.5, "Super Potion", hiddenIcon, currentMap)
...
markerSet(-231.45, 291.5, "TM82 (Sleep Talk)", tmIcon, currentMap)
...
markerSet(-193.62, 375.18, "Draco Plate", hiddenIcon, currentMap)
markerSet(-192.06, 395.18, "Moon Stone", hiddenIcon, currentMap)
// Route 206
markerSet(-319.25, 361.12, "PP Up", hiddenIcon, currentMap)
markerSet(-296.18, 361.18, "Ether", hiddenIcon, currentMap)
markerSet(-300.25, 350.18, "Burn Heal", itemIcon, currentMap)
markerSet(-287.06, 343.18, "TinyMushroom", hiddenIcon, currentMap)
...
markerSet(-189.5, 443.18, "TM29 (Psychic)", tmIcon, currentMap)
markerSet(-208.92, 452.12, "Carbos", itemIcon, currentMap)
markerSet(-189.5, 450.25, "Calcium", hiddenIcon, currentMap)
...
markerSet(-200.45, 476.12, "King's Rock", hiddenIcon, currentMap)
// Route 210
markerSet(-261, 573.08, "Super Repel", itemIcon, currentMap)
markerSet(-267.5, 584.12, "Rare Candy", hiddenIcon, currentMap)
markerSet(-245.55, 565.06, "Max Repel", itemIcon, currentMap)
markerSet(-241.82, 568.12, "Full Heal", hiddenIcon, currentMap)
markerSet(-233.32, 574.12, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-235.42, 581.12, "Hyper Potion", itemIcon, currentMap)
markerSet(-239.55, 585.12, "Hyper Potion", hiddenIcon, currentMap)
markerSet(-232.62, 592.12, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-220.82, 594.12, "Nest Ball", itemIcon, currentMap)
markerSet(-213.12, 570.16, "Red Shard", itemIcon, currentMap)
markerSet(-196.82, 545.16, "Meadow Plate", hiddenIcon, currentMap)
...
// Route 209
markerSet(-350.45, 541.06, "Great Ball", hiddenIcon, currentMap)
markerSet(-345.75, 546.06, "Great Ball", itemIcon, currentMap)
markerSet(-356.55, 558.06, "Super Repel", hiddenIcon, currentMap)
markerSet(-355, 576.18, "Hyper Potion", itemIcon, currentMap)
markerSet(-359.62, 587.25, "TM19 (Giga Drain)", tmIcon, currentMap)
markerSet(-347.18, 569.36, "Revive", hiddenIcon, currentMap)
markerSet(-343.18, 575.12, "Ether", itemIcon, currentMap)
markerSet(-335.82, 584.18, "Stardust", hiddenIcon, currentMap)
markerSet(-319.62, 567.12, "Calcium", itemIcon, currentMap)
markerSet(-333.36, 591.25, "TM47 (Steel Wing)", tmIcon, currentMap)
...
// Hearthome City 
markerSet(-324.82, 489.24, "Big Mushroom", hiddenIcon, currentMap)
// Route 208
markerSet(-363.55, 447.06, "TinyMushroom", hiddenIcon, currentMap)
markerSet(-349.24, 435, "Ether", itemIcon, currentMap)
markerSet(-355, 418, "Great Ball", itemIcon, currentMap)
markerSet(-349.32, 408, "Star Piece", hiddenIcon, currentMap)
...
markerSet(-457.32, 494, "TM84 (Poison Jab)", tmIcon, currentMap)
markerSet(-451.45, 526, "TM62 (Silver Wind)", tmIcon, currentMap)
markerSet(-461.85, 512, "Max Ether", hiddenIcon, currentMap)
markerSet(-459.12, 490, "Big Mushroom", hiddenIcon, currentMap)
markerSet(-453.55, 546, "Max Repel", hiddenIcon, currentMap)
markerSet(-455.12, 550, "Elixir", itemIcon, currentMap)
markerSet(-456.62, 553, "Full Heal", hiddenIcon, currentMap)
markerSet(-461.32, 552, "Rare Candy", hiddenIcon, currentMap)
markerSet(-465.12, 565.92, "TM06 (Toxic)", tmIcon, currentMap)
markerSet(-451.12, 577, "Revive", itemIcon, currentMap)
markerSet(-447.40, 590, "Hyper Potion", hiddenIcon, currentMap)
markerSet(-444.32, 589, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-444.32, 580, "Dawn Stone", hiddenIcon, currentMap)
...
// Route 213
markerSet(-428.55, 708.06, "HP Up", hiddenIcon, currentMap)
markerSet(-433.95, 706.06, "TM05 (Roar)", tmIcon, currentMap)
markerSet(-441.12, 694.06, "TM40 (Aerial Ace)", tmIcon, currentMap)
markerSet(-436.12, 667.06, "Hyper Potion", hiddenIcon, currentMap)
markerSet(-451.92, 678.06, "Heart Scale", hiddenIcon, currentMap)
markerSet(-448.55, 684.62, "Pearl", hiddenIcon, currentMap)
markerSet(-456.92, 703, "Max Revive", itemIcon, currentMap)
markerSet(-460.45, 700.06, "Big Pearl", hiddenIcon, currentMap)
markerSet(-446.06, 743, "Water Stone", itemIcon, currentMap)
markerSet(-460.45, 739, "Big Pearl", hiddenIcon, currentMap)
markerSet(-440.62, 719.06, "Pearl", hiddenIcon, currentMap)
markerSet(-441.32, 731.06, "Heart Scale", hiddenIcon, currentMap)
markerSet(-437.45, 729.06, "Pearl", hiddenIcon, currentMap)
markerSet(-429.68, 717.06, "Yellow Shard", itemIcon, currentMap)
markerSet(-424.45, 722.12, "Suite Key", hiddenIcon, currentMap)
markerSet(-425.82, 734, "Protein", itemIcon, currentMap)
markerSet(-409.75, 737.06, "Sun Stone", hiddenIcon, currentMap)
markerSet(-413.62, 709, "Max Revive", hiddenIcon, currentMap)
markerSet(-422.32, 707.06, "PP Up", itemIcon, currentMap)
markerSet(-399.75, 729.06, "Iron", itemIcon, currentMap)
markerSet(-402.06, 729.06, "TM85 (Dream Eater)", tmIcon, currentMap)
markerSet(-377, 734.06, "Ultra Ball", itemIcon, currentMap)
markerSet(-374.75, 733.06, "Big Mushroom", hiddenIcon, currentMap)
...
markerSet(-345.92, 739.06, "Razor Fang", hiddenIcon, currentMap)
markerSet(-363.85, 739.06, "Red Shard", itemIcon, currentMap)
markerSet(-343.85, 741.06, "Big Root", itemIcon, currentMap)
markerSet(-339.25, 741.06, "Carbos", hiddenIcon, currentMap)
markerSet(-328.25, 751, "Big Mushroom", hiddenIcon, currentMap)
...
markerSet(-249.50, 676.12, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-253.12, 678.12, "TM34 (Shock Wave)", tmIcon, currentMap)
markerSet(-255.68, 660.12, "Iron", hiddenIcon, currentMap)
...
markerSet(-396.36, 800.06, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-395.36, 747.18, "PP Up", hiddenIcon, currentMap)
markerSet(-402.25, 802, "Full Restore", itemIcon, currentMap)
markerSet(-407.36, 782, "Pearl", hiddenIcon, currentMap)
markerSet(-408.62, 788.06, "Heart Scale", hiddenIcon, currentMap)
markerSet(-408.62, 813.12, "Heart Scale", hiddenIcon, currentMap)
markerSet(-403.06, 815.06, "PP Up", itemIcon, currentMap)
markerSet(-410.25, 823.09, "Full Restore", hiddenIcon, currentMap)
markerSet(-408.55, 826.12, "Quick Ball", itemIcon, currentMap)
markerSet(-410.25, 830.09, "TinyMushroom", hiddenIcon, currentMap)
markerSet(-408.62, 836.06, "Big Mushroom", hiddenIcon, currentMap)
...
// Sunyshore City
markerSet(-408.12, 906.06, "Zap Plate", hiddenIcon, currentMap)
markerSet(-400.62, 898.06, "Thunderstone", itemIcon, currentMap)
markerSet(-383.55, 873.12, "Carbos", hiddenIcon, currentMap)
// Route 223
markerSet(-360.55, 866.06, "Heart Scale", hiddenIcon, currentMap)
markerSet(-327.55, 857.06, "TM18 (Rain Dance)", tmIcon, currentMap)
markerSet(-300.50, 867.06, "Ultra Ball", itemIcon, currentMap)
markerSet(-306.12, 859.06, "Heart Scale", hiddenIcon, currentMap)
...
markerSet(-205.36, 924.04, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-208.36, 897.04, "Rare Candy", hiddenIcon, currentMap)
markerSet(-239.12, 900.06, "Razor Claw", itemIcon, currentMap)
markerSet(-212.12, 915.06, "Pearl", hiddenIcon, currentMap)
markerSet(-208.55, 924.04, "Heart Scale", hiddenIcon, currentMap)
markerSet(-210.45, 930.04, "Big Pearl", hiddenIcon, currentMap)
markerSet(-207.12, 933.04, "Pearl", hiddenIcon, currentMap)
...
markerSet(-28.45, 434, "Rare Candy", hiddenIcon, currentMap)
// Acuity Lakefront
markerSet(-36.32, 393.12, "Ultra Ball", itemIcon, currentMap)
markerSet(-37.62, 376.12, "Reaper Cloth", itemIcon, currentMap)
// Route 217
markerSet(-89.62, 344.62, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-83.55, 369.06, "Max Revive", hiddenIcon, currentMap)
markerSet(-92.82, 371.12, "Max Potion", hiddenIcon, currentMap)
markerSet(-97.45, 369.06, "Rare Candy", itemIcon, currentMap)
markerSet(-96.75, 358.12, "Max Repel", hiddenIcon, currentMap)
markerSet(-102, 353.06, "TM07 (Hail)", tmIcon, currentMap)
markerSet(-104.45, 352.12, "Protein", hiddenIcon, currentMap)
markerSet(-114.45, 345.12, "Iron", hiddenIcon, currentMap)
markerSet(-113.55, 359.12, "Iron", itemIcon, currentMap)
markerSet(-108.25, 366.06, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-127.55, 367.12, "Full Heal", hiddenIcon, currentMap)
markerSet(-129, 364.06, "Ultra Ball", itemIcon, currentMap)
markerSet(-132.12, 358.12, "Revival Herb", hiddenIcon, currentMap)
markerSet(-119, 341.12, "Nugget", hiddenIcon, currentMap)
...
markerSet(-170.12, 410.12, "PP Up", hiddenIcon, currentMap)
...
markerSet(-156.32, 430.12, "TM13 (Ice Beam)", tmIcon, currentMap)
// Fight Area
...
markerSet(-115, 633.68, "Rare Candy", hiddenIcon, currentMap)
markerSet(-129.55, 642.68, "Big Mushroom", hiddenIcon, currentMap)
markerSet(-130.24, 617.68, "Revive", itemIcon, currentMap)
markerSet(-118.55, 620.68, "Leaf Stone", hiddenIcon, currentMap)
...
markerSet(-84.75, 627.68, "Ultra Ball", hiddenIcon, currentMap)
...
// Survival Area
markerSet(-97.45, 655.68, "PP Up", hiddenIcon, currentMap)
markerSet(-89.06, 668.92, "Rare Candy", hiddenIcon, currentMap)
...
markerSet(-90.18, 723.82, "TM53 (Energy Ball)", tmIcon, currentMap)
markerSet(-86.24, 725.82, "TinyMushroom", hiddenIcon, currentMap)
markerSet(-87, 730.82, "Big Mushroom", hiddenIcon, currentMap)
markerSet(-84.68, 729.82, "PP Max", hiddenIcon, currentMap)
markerSet(-96.82, 721.82, "Heart Scale", hiddenIcon, currentMap)
markerSet(-82, 750.75, "Rare Candy", hiddenIcon, currentMap)
...
markerSet(-46.62, 755.75, "Max Repel", hiddenIcon, currentMap)
...
markerSet(-31.25, 747.68, "Star Piece", hiddenIcon, currentMap)
...
markerSet(-173.82, 828.62, "Thunderstone", hiddenIcon, currentMap)
...
markerSet(-152.68, 724.55, "Ultra Ball", hiddenIcon, currentMap)
markerSet(-158.56, 731.50, "Water Stone", hiddenIcon, currentMap)
...
// Route 228
markerSet(-141.68, 781.45, "PP Max", hiddenIcon, currentMap)
markerSet(-139.24, 799.45, "Calcium", hiddenIcon, currentMap)
markerSet(-126.55, 800.45, "Shiny Stone", itemIcon, currentMap)
markerSet(-123.82, 785.45, "TM37 (Sandstorm)", tmIcon, currentMap)
markerSet(-111.92, 787.45, "Star Piece", hiddenIcon, currentMap)
markerSet(-106.12, 780.45, "Full Restore", hiddenIcon, currentMap)
markerSet(-96.12, 786.45, "Shed Shell", itemIcon, currentMap)
markerSet(-97.75, 802.45, "Iron", itemIcon, currentMap)
markerSet(-87.92, 786.45, "Rare Candy", hiddenIcon, currentMap)
markerSet(-82.18, 784.45, "Max Repel", hiddenIcon, currentMap)
